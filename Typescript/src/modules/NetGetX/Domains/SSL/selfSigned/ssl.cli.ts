...
import { storeConfigInDB, updateSSLCertificatePaths } from '../../../../../kernel/domainStore.js';
import { loadXConfig } from '../../../config/xConfig.ts';
import { getDomainByName, updateDomain } from '../../../../../kernel/domainStore.js';
...
const domainSSLConfiguration = async (domain: string): Promise<void> => {
    try {
        ...
        const domainConfig: DomainConfig = rec as unknown as DomainConfig;
    ...
    if (certificatesIssued) {
        ...
        switch (answer.action) {
            ...
            case 'viewLogs':
                ...
                break;
            case 'editSSLMethod':
                await updateDomain(domain, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
