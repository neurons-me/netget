...
const DomainDetail = () => {
    ...
    }, [domainName, location, navigate, fetchDomainData]);
                        ...
                        {subdomains.length > 0 ? (
                            <DataGrid
                                ...
                                onRowClick={(params) => {
                                    ...
                                    const subdomainData = { ...params.row };
                                    delete subdomainData.id;
                        ...
                        <Grid item xs={12} sm={6}>
                            <FormControl fullWidth>
                                ...
                                >
                                    ...
                                    <MenuItem value="letsencrypt">Lets Encrypt</MenuItem>
